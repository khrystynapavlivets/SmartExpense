...
# settings.DATABASE_URL is used directly (not via config.set_main_option) because
# ConfigParser applies %-interpolation to ini values, which breaks on passwords
