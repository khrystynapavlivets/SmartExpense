...
def test_upload_receipt_success(client, mocker, fake_image_file):
    ...
    mocker.patch("app.api.v1.routes.expenses.extract_with_vision", return_value=mock_expense)
...
def test_upload_rejects_non_receipt(client, mocker, fake_image_file):
    ...
    mocker.patch("app.api.v1.routes.expenses.extract_with_vision", return_value=mock_expense)
    mocker.patch("app.api.v1.routes.expenses.classify_document", return_value="utility_bill")
